...
${nuget_cmd} install src/ApsNET/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ApsNET.dll"
...
then
  ...
  echo "[INFO] bin/ApsNET.dll was created successfully"
fi
